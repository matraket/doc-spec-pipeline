#!/usr/bin/env python3
"""
Extrae los Requisitos No Funcionales Técnicos de 008_rnf-tecnicos.md
en archivos individuales: references/rnft/rnft-{xxx}.md
"""
...
HEADING_PATTERN = r'### \d+\.\d+\s+(?P<code>RNFT-\d+):\s*(?P<title>.+)'
HEADING_LEVEL = 3
OUTPUT_SUBDIR = 'rnft'
...
if __name__ == '__main__':
    ...
    print(f"RNFT: {len(files)} archivos generados en {OUTPUT_SUBDIR}/")
